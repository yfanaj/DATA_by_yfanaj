...
!   real(rk8) , pointer , dimension(:) :: xirrig
  ...
  type , public :: column_wstate_type
    ...
    ! yfanaj add gw-pumped irrigation fraction on 29-Oct-2024
    real(rk8) , pointer , dimension(:) :: gwp
    ! yfanaj add 2d irrigation fraction on 26-Dec-2024
    real(rk8) , pointer , dimension(:) :: mad
    !frost table depth
