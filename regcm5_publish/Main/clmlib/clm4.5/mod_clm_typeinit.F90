...
!   cps%xirrig(ibeg:iend) = 0._rk8
  ...
  subroutine init_column_wstate_type(ibeg,iend,cws)
    ...
    allocate(cws%gwp(ibeg:iend)) !yfanaj 29-Oct-2024
    allocate(cws%mad(ibeg:iend)) !yfanaj 26-Dec-2024
    ...
    cws%gwp(ibeg:iend) = nan ! yfanaj 29-Oct-2024
    cws%mad(ibeg:iend) = 0.7 ! yfanaj 26-Dec-2024
