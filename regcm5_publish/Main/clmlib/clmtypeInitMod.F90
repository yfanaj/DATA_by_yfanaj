...
!------------------------------------------------------------------------
    ...
    allocate(cws%gwp(beg:end)) !yfanaj 29-Oct-2024
    allocate(cws%mad(beg:end)) !yfanaj 26-Dec-2024
    ...
    cws%zwt(beg:end) = nan
    cws%gwp(beg:end) = nan !yfanaj 29-Oct-2024
    cws%mad(beg:end) = nan !yfanaj 27-Dec-2024
