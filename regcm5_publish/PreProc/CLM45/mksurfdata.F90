...
program mksurfdata
  ...
  use mod_mkorganic
  use mod_mklake
  use mod_mkgwp ! yfanaj add mkgwp on 29-Oct-2024
  use mod_mkmad ! yfanaj add mkmad on 27-Dec-2024
  use mod_zita
  use netcdf
#ifdef CN
  use mod_mklightning
  ...
  integer(ik4) :: igwpvar,igwp2dvar ! yfanaj add gwp and gwp2d on 29-Oct-2024
  integer(ik4) :: imadvar,imad2dvar ! yfanaj add mad and mad2d on 27-Dec-2024
...
#endif
    npft = 25
    ! yfanaj change the nc name here
    pftfile = 'mksrf_24pft.dirr'
  ...
  ! yfanaj add gwp on 29-Oct-2024
  istatus = nf90_def_var(ncid, 'GWP', regcm_vartype, idims(7), igwpvar)
  call checkncerr(istatus,__FILE__,__LINE__,  'Error add var gwp')
  istatus = nf90_put_att(ncid, igwpvar, 'long_name','GW-pumped irrigation fraction')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add gwp long_name')
  istatus = nf90_put_att(ncid, igwpvar, 'units','fraction')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add gwp units')

  ! yfanaj add mad on 26-Dec-2024
  istatus = nf90_def_var(ncid, 'MAD', regcm_vartype, idims(7), imadvar)
  call checkncerr(istatus,__FILE__,__LINE__,  'Error add var mad')
  istatus = nf90_put_att(ncid, imadvar, 'long_name','irrigation management allowable deficit')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add mad long_name')
  istatus = nf90_put_att(ncid, imadvar, 'units','fraction')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add mad units')
  ...
  ! yfanaj add gwp2d on 29-Oct-2024
  istatus = nf90_def_var(ncid, 'gwp_2d', regcm_vartype, ivdims(1:2), igwp2dvar)
  call checkncerr(istatus,__FILE__,__LINE__,  'Error add var gwp_2d')
  istatus = nf90_put_att(ncid, igwp2dvar, 'long_name','percent gw-pumped irrigation')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add gwp_2d long_name')
  istatus = nf90_put_att(ncid, igwp2dvar, 'units','fraction')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add gwp_2d units')
  istatus = nf90_put_att(ncid, igwp2dvar, '_FillValue',vmisdat)
  call checkncerr(istatus,__FILE__,__LINE__,'Error add gwp_2d Fill Value')

  ! yfanaj add mad2d on 26-Dec-2024
  istatus = nf90_def_var(ncid, 'mad_2d', regcm_vartype, ivdims(1:2), imad2dvar)
  call checkncerr(istatus,__FILE__,__LINE__,  'Error add var mad_2d')
  istatus = nf90_put_att(ncid, imad2dvar, 'long_name','irrigation management allowable deficit')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add mad_2d long_name')
  istatus = nf90_put_att(ncid, imad2dvar, 'units','fraction')
  call checkncerr(istatus,__FILE__,__LINE__,'Error add mad_2d units')
  istatus = nf90_put_att(ncid, imad2dvar, '_FillValue',vmisdat)
  call checkncerr(istatus,__FILE__,__LINE__,'Error add mad_2d Fill Value')
  ...
  ! yfanaj add gwp and gwp2d on 29-Oct-2024
  allocate(var2d(jxsg,iysg))
  call mkgwp('mksrf_gwp.nc',xmask,var2d)
  call mypack(var2d,gcvar)
  istatus = nf90_put_var(ncid, igwpvar, gcvar)
  call checkncerr(istatus,__FILE__,__LINE__, 'Error write gwp')
  istatus = nf90_put_var(ncid, igwp2dvar, var2d)
  call checkncerr(istatus,__FILE__,__LINE__, 'Error write gwp_2d')
  deallocate(var2d)
  write(stdout,*) 'Created groundwater informations...'

  ! yfanaj add mad and mad2d on 27-Dec-2024
  allocate(var2d(jxsg,iysg))
  call mkmad('mksrf_mad.nc',xmask,var2d)
  call mypack(var2d,gcvar)
  istatus = nf90_put_var(ncid, imadvar, gcvar)
  call checkncerr(istatus,__FILE__,__LINE__, 'Error write mad')
  istatus = nf90_put_var(ncid, imad2dvar, var2d)
  call checkncerr(istatus,__FILE__,__LINE__, 'Error write mad_2d')
  deallocate(var2d)
  write(stdout,*) 'Created MAD irrigation factors...'
